...
data='
	...
	, "bufferset"       : '$( [[ -e $dirsystem/bufferset ]] && echo true || echo false )'
	...
	, "bufferoutputset" : '$( [[ -e $dirsystem/bufferoutputset ]] && echo true || echo false )'
	...
	, "crossfadeset"    : '$( [[ -e $dirsystem/crossfadeset ]] && echo true || echo false )'
	, "crossfadeval"    : '$( cat $dirsystem/crossfadeset 2> /dev/null || echo false )'
	, "custom"          : '$( [[ -e $dirsystem/custom ]] && echo true || echo false )'
	, "customset"       : '$( [[ -e $dirsystem/customset ]] && echo true || echo false )'
	, "customval"       : "customset"
